(define (problem p36)
  ...
  (:objects 
    p11 p12 p13 p14 p15 p21 p22 p23 p24 p25 p31 p32 p33 p34 p35 p41 p42 p43 p44 p45 p51 p52 p53 p54 p55 p61 p62 p63 p64 p65 p71 p72 p73 p74 p75 p81 p82 p83 p84 p85 p91 p92 p93 p94 p95 p101 p102 p103 p104 p105 - patch 
  )
  (:init
