(define (problem p25)
  ...
  (:objects 
    p11 p12 p13 p14 p15 p16 p17 p18 p19 p21 p22 p23 p24 p25 p26 p27 p28 p29 p31 p32 p33 p34 p35 p36 p37 p38 p39 p41 p42 p43 p44 p45 p46 p47 p48 p49 p51 p52 p53 p54 p55 p56 p57 p58 p59 p61 p62 p63 p64 p65 p66 p67 p68 p69 p71 p72 p73 p74 p75 p76 p77 p78 p79 - patch 
  )
  (:init
    ...
    (CONNECTED p77 p18 north-east)
    (CONNECTED p77 p17 east)
    (CONNECTED p77 p16 south-east)
    (CONNECTED p78 p19 north-east)
    (CONNECTED p78 p18 east)
    (CONNECTED p78 p17 south-east)
    (CONNECTED p79 p19 east)
    (CONNECTED p79 p18 south-east)
    (is-focal-point p15)
    (is-target p12)
    (is-target p14)
    (is-target p15)
