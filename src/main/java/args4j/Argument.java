 ...
 *
 * <ol>
 * <li>Arguments have an index about their relative position on the command
 * line.
 * </ol>
 *
...
public @interface Argument {
	 ...
	 *
	 * <p>
	 * If you define multiple single value properties to bind to arguments, they
	 * should have {@code index=0, index=1, index=2}, ... and so on.
	 *
	 * <p>
