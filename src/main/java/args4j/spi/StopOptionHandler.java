 ...
 * <tt>--</tt> that indicates that the rest of tokens are not options, but
 * arguments.
 *
 * <p>
 ...
 *
 * <p>
 * The command line <samp>-n 5 abc def</samp> would parse into
 * {@code n=5, args= "abc",def"} , but <samp> -- -n 5 abc def</samp> would parse
 * into {@code n=0, args= "-n","5","abc","def"} .
 *
