 ...
 */
public class UuidOptionHandler extends OneArgumentOptionHandler<UUID> {
	public UuidOptionHandler(CmdLineParser parser, OptionDef option, Setter<? super UUID> setter) {
	...
	protected UUID parse(String argument) throws CmdLineException {
		try {
			...
			throw new CmdLineException(owner, Messages.ILLEGAL_UUID, argument);
		}
	}
