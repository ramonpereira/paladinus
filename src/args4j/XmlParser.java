...
import args4j.spi.ArgumentImpl;
import args4j.spi.ConfigElement;
import args4j.spi.OptionImpl;
import args4j.spi.Setters;
import org.xml.sax.InputSource;

/**
 * Parses an XML-file specifying the 'annotations'. The XML must have the
 * structure:
 *
 * <pre>
 * &lt;args>
 ...
 * </pre>
 *
 * Exactly one of the attributes 'field' or 'method' must be set. The 'handler'
 * value specifies a full qualified class name.
 *
 * <h3>Example</h3>
 *
 * <pre>
...
public class XmlParser {
	...
	public void parse(InputSource xml, CmdLineParser parser, Object bean) {
		try {
			...
			for (ConfigElement ce : config.arguments) {
				...
				parser.addArgument(Setters.create(parser, findMethodOrField(bean, ce.field, ce.method), bean),
						argument);
			}
		} catch (Exception e) {
	...
	/**
	 * Finds a {@link java.lang.reflect.Method} or {@link java.lang.reflect.Method}
	 * in the bean instance with the requested name.
	 *
	 ...
	 */
	private AccessibleObject findMethodOrField(Object bean, String field, String method)
			throws SecurityException, NoSuchFieldException, NoSuchMethodException, ClassNotFoundException {
		AccessibleObject rv;
		if (field != null) {
