 ...
 *
 * <p>
 * Because of the {@link CmdLineParser} abstractions of allowing incremental
 * parsing of options, this implementation creates a whole new array each time a
 * new value is found.
 *
 * This is also why we don't support a setter method that takes list/array as
 * arguments.
 *
