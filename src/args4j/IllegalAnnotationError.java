 ...
 *
 * <p>
 * This only happens when there's something wrong with the way you use args4j in
 * your code-- <em>not</em> when the user's arguments are wrong. Therefore, this
 * class is an {@link Error}.
 *
