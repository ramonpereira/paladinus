...
public class ParserProperties {
	...
	/**
	 * Returns an instance of the default parser properties. This instance can be
	 * manipulated with the {@code withXXX()} methods in this class.
	 */
	...
	/**
	 * Sets the width of a usage line. If the usage message is longer than this
	 * value, the parser wraps the line.
	 *
	 * Defaults to {@code 80}.
	 *
	 ...
	 *
	 * @param sorter If non-{@code null}, options are sorted in the order induced by
	 *               this comparator.
	 */
	...
	/**
	 * @return {@code null} if options are left unsorted and should be listed by
	 *         their discovery order. Otherwise the returned comparator is used to
	 *         sort options. The default value is a comparator that sorts options
	 *         alphabetically.
	 */
	...
	/**
	 * Sets the string used to separate option name and its value (such as --foo=bar
	 * vs --foo bar)
	 *
	 * Default to whitespace. Note that the tokens separated in the argument array
	 * (such as '-foo','bar') is always recognized as a valid name/value separator.
	 *
	 */
