...
/**
 * Starter class which uses reflection to instantiate the business class, parse
 * the command line parameters, sets the fields of the business class and doing
 * the help message handling.
 *
 * @author Jan Materne
 */
public class Starter {
	...
	/**
	 * The name of the JavaVM property which stores the class name of the business
	 * class. * {@value}
	 */
	...
	public static void main(String[] args) {
		...
		if (classname == null || "".equals(classname)) {
			System.err.println("The system property '" + PARAMETER_NAME + "' must contain the classname to start.");
			System.exit(-1);
		}
		...
		try {
			...
			System.err.println("Cant find the class '" + classname + "' as specified in the system property '"
					+ PARAMETER_NAME + "'.");
