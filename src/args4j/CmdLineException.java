...
public class CmdLineException extends Exception {
	...
	/**
	 * @deprecated Use {@link #CmdLineException(CmdLineParser, String)}
	 */
	@Deprecated
	...
	/**
	 * @deprecated Use {@link #CmdLineException(CmdLineParser, String, Throwable)}
	 */
	@Deprecated
	...
	/**
	 * @deprecated Use {@link #CmdLineException(CmdLineParser, Throwable)}
	 */
	@Deprecated
	...
	public CmdLineException(CmdLineParser parser, Localizable message, String... args) {
		...
		localizedMessage = message.format((Object[]) args);
		this.parser = parser;
	}

	/**
	 * @deprecated Use
	 *             {@link #CmdLineException(org.kohsuke.args4j.CmdLineParser, Localizable, java.lang.String...) }
	 */
	@Deprecated
	 ...
	 *
	 * <p>
	 * Unless you have legacy {@link OptionHandler} that doesn't pass in this
	 * information when it throws an exception, this method should always return a
	 * non-null value.
	 */
